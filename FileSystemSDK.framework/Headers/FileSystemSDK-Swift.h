...
#ifndef FILESYSTEMSDK_SWIFT_H
#define FILESYSTEMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FileSystemSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithName:(NSString * _Nullable)name searchDirectoryType:(enum NSSearchPathDirectory)searchDirectoryType OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, strong) id <IDocumentMetadata> _Nonnull metadata;
- (NSString * _Nullable)path SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isFolder SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
...
typedef SWIFT_ENUM_NAMED(NSInteger, SpaceIn, "SpaceIn", open) {
  SpaceInBytes = 0,
  SpaceInKb = 1,
  SpaceInMb = 2,
  SpaceInGb = 3,
