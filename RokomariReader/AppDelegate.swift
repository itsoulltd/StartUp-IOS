...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func registerSignoutObserver(){
        if signoutObserver == nil{
            ...
            signoutObserver = NSNotificationCenter.defaultCenter().addObserverForName(Notifications.UserLogout, object: nil, queue: NSOperationQueue.mainQueue(), usingBlock: { (notification: NSNotification!) -> Void in
