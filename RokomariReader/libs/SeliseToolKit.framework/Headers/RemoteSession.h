...
@property (readonly) SessionDelegateHandler *delegateHandler;
...
- (instancetype)initWithBackgroundSessionIdentifier:(NSString*)identifier andSessionDelegate:(SessionDelegateHandler*)handler;
- (RemoteDownloadTask*) resumeDownloadFrom:(RemoteDownloadTask*)task;
- (void) addCompletionHandler: (CompletionHandlerType) handler forSession: (NSString *)identifier;
- (void) addCompletionHandler: (CompletionHandlerType) handler forSession: (NSString *)identifier andSessionDelegate:(SessionDelegateHandler*)sessionDelegate;
